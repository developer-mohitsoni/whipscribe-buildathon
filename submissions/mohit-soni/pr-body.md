...
This PR submits my Track 0 profile for the WhipScribe Buildathon, including my background, LinkedIn, GitHub, proudest projects, production work experience, and the tracks I plan to work on next.

**How to try it**

Review `submissions/mohit-soni/introduction.md`.

**What works, what does not yet**

Works:
- Track 0 introduction is written.
- LinkedIn, GitHub, proudest projects, and contribution links are included.
- My next intended tracks are listed.
...
Mohit Soni  
Software Engineer, ex-dBee.ai  
LinkedIn: https://www.linkedin.com/in/mohit-soni-781b6b250/  
GitHub: https://github.com/developer-mohitsoni  
...
- LinkedIn: https://www.linkedin.com/in/mohit-soni-781b6b250/
- Shipped apps: None yet as live store/deployed apps with active users
- Hackathon wins: Hacktoberfest 2025 completed, received swag
